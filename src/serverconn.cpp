...
PVXS_API std::set<std::string> ClientCredentials::roles() const { return PeerCredentials::roles(); };
 ...
 */
void ServerConn::peerStatusCallback(certs::cert_status_class_t status_class) {
