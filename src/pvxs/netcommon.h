...
//! Advertises that PeerCredentials carries Subject Alternative Name (SAN) entries
//! extracted from X.509 peer certificates, and that SanEntry is available in this
//! public header. Downstream consumers may conditionally depend on peer SANs via
//! `#ifdef PVXS_HAS_SAN_EXTRACT`.
//! @since UNRELEASED
#define PVXS_HAS_SAN_EXTRACT 1
